...
# offset -> (title, rank, greek)
# rank: 1 Pascha · 2 Great Feast · 3 major · 4 notable
MOVABLE_DAYS: dict[int, tuple[str, int, str]] = {
    -70: ("Sunday of the Publican and the Pharisee", 4, ""),
    -63: ("Sunday of the Prodigal Son", 4, ""),
    -57: ("Saturday of Souls", 4, "Ψυχοσάββατον"),
    -56: ("Sunday of the Last Judgement (Meatfare)", 4, "Ἀπόκρεω"),
    -50: ("Saturday of the Ascetics", 4, ""),
    -49: ("Forgiveness Sunday (Cheesefare)", 4, "Τυρινή"),
    -48: ("Clean Monday", 3, "Καθαρὰ Δευτέρα"),
    -44: ("First Salutations to the Theotokos", 4, "Α΄ Χαιρετισμοί"),
    -43: ("Saturday of St. Theodore the Recruit", 4, ""),
    -42: ("Sunday of Orthodoxy", 3, "Κυριακὴ τῆς Ὀρθοδοξίας"),
    -37: ("Second Salutations to the Theotokos", 4, "Β΄ Χαιρετισμοί"),
    -35: ("Sunday of St. Gregory Palamas", 4, ""),
    -30: ("Third Salutations to the Theotokos", 4, "Γ΄ Χαιρετισμοί"),
    -28: ("Sunday of the Veneration of the Cross", 3, "Σταυροπροσκυνήσεως"),
    -23: ("Fourth Salutations to the Theotokos", 4, "Δ΄ Χαιρετισμοί"),
    -21: ("Sunday of St. John Climacus", 4, ""),
    -16: ("The Akathist Hymn", 3, "Ἀκάθιστος Ὕμνος"),
    -14: ("Sunday of St. Mary of Egypt", 4, ""),
    -8:  ("Lazarus Saturday", 3, "Σάββατον τοῦ Λαζάρου"),
    -7:  ("Palm Sunday", 2, "Κυριακὴ τῶν Βαΐων"),
    -6:  ("Great and Holy Monday", 3, ""),
    -5:  ("Great and Holy Tuesday", 3, ""),
    -4:  ("Great and Holy Wednesday", 3, ""),
    -3:  ("Great and Holy Thursday", 3, ""),
    -2:  ("Great and Holy Friday", 2, "Μεγάλη Παρασκευή"),
    -1:  ("Great and Holy Saturday", 2, "Μέγα Σάββατον"),
     0:  ("Great and Holy Pascha", 1, "Τὸ Ἅγιον Πάσχα"),
     1:  ("Bright Monday", 3, ""),
     2:  ("Bright Tuesday", 3, ""),
     3:  ("Bright Wednesday", 3, ""),
     4:  ("Bright Thursday", 3, ""),
     5:  ("Bright Friday · the Life-Giving Spring", 3, "Ζωοδόχου Πηγῆς"),
     6:  ("Bright Saturday", 3, ""),
     7:  ("Thomas Sunday (Antipascha)", 3, "Τοῦ Θωμᾶ"),
    14:  ("Sunday of the Myrrh-Bearing Women", 4, "Τῶν Μυροφόρων"),
    21:  ("Sunday of the Paralytic", 4, ""),
    24:  ("Mid-Pentecost", 4, "Μεσοπεντηκοστή"),
    28:  ("Sunday of the Samaritan Woman", 4, ""),
    35:  ("Sunday of the Blind Man", 4, ""),
    39:  ("The Ascension of the Lord", 2, "Ἀνάληψις"),
    42:  ("Sunday of the Fathers of the First Council", 4, ""),
    48:  ("Saturday of Souls before Pentecost", 4, "Ψυχοσάββατον"),
    49:  ("Holy Pentecost", 2, "Πεντηκοστή"),
    50:  ("Monday of the Holy Spirit", 3, "Ἁγίου Πνεύματος"),
    56:  ("Sunday of All Saints", 3, "Τῶν Ἁγίων Πάντων"),
}


def movable_day(offset: int) -> tuple[str, int, str] | None:
    """Title, rank and Greek for a movable commemoration, if any."""
