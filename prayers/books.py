...
_ALIASES: dict[str, tuple[str, ...]] = {
    ...
    "SNG": ("sng", "song", "songofsongs", "песньпесней", "songofsolomon"),
    ...
    "1CH": ("1ch", "1chron", "1chronicles", "1паралипоменон"),
    "2CH": ("2ch", "2chron", "2chronicles", "2паралипоменон"),
    "EZR": ("ezr", "ezra", "ездры"),
    "NEH": ("neh", "nehemiah", "неемии"),
    "EST": ("est", "esther", "есфирь"),
    "HOS": ("hos", "hosea", "осия"),
    "OBA": ("oba", "obad", "obadiah", "авдия"),
    "NAM": ("nam", "nah", "nahum", "наум"),
    "HAB": ("hab", "habakkuk", "аввакум"),
    "ZEP": ("zep", "zeph", "zephaniah", "софония"),
    "HAG": ("hag", "haggai", "аггей"),
    "ZEC": ("zec", "zech", "zechariah", "захария"),
